...
<head>
                                            <tbody>
                                              <tr>
                                                ...
                                                <td><form action="edit.php?email=<?php echo $r['email']; ?>" method="POST" enctype="multipart/form-data" ><input type="submit" name="edit" value="Edit" class="btn btn-primary" /></form></td>
                                                <td><form action="delete.php?email=<?php echo $r['email']; ?>" method="POST" enctype="multipart/form-data" ><input type="submit" name="delete" value="Delete"  class="btn btn-danger" /></form></td>
