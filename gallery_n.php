  ...
  <head>
                                            <tbody>
                                              <tr>
                                                ...
                                                <td><?php echo $r1['cdate'];?></td>
                                                <td><?php echo $r1['dept'];?></td>
                                                
                              <td><form action="gallery_n.php?id=<?php echo $r1['id']; ?>" method="POST"> <input type="submit" name="sub" class="btn btn-danger" value="Delete"></form></td>                                                
