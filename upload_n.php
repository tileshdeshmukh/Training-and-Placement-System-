...
<div class="p-5" style="padding: 30px">
  ...
  <form action="upload_n.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                 ...
                 <br>
                 <input type="submit" name="sub" value="Add Image" class="btn btn-primary">
            </div>
...
$q = mysqli_query($conn, "insert into img(img) values('$image')");

 if(move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file))
          {
            echo '<script>alert("Image Successfully entered");</script>';
          }
          else{
